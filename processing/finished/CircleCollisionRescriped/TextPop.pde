...
/*
 ...
 Damage-values or small info signs.
 
 The variable "popMode" is a String that works as 6 different boolean values.
...
class TextPop{
  ...
  TextPop(String theText, float x, float y, float volume, int lifeTime, color colour, String popMode){t = theText;
    this.x = x;
    this.y = y;
    xStart = x;
    yStart = y;
  ...
  void update(){
    float a = 0.1; // bace variation value
    //shakePosition
