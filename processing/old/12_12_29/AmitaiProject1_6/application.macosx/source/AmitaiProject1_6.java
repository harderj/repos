...
public class AmitaiProject1_6 extends PApplet {
...
public void setup() {
  ...
  goals.add(new IntVect(width*0.1f, height*0.8f));
}
...
public int[] pushIntoArray(int a, int[] l, int s){ // a = number l = list | s = startpoint of push
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "AmitaiProject1_6" });
  }
}
