...
public class AmitaiProject1_7 extends PApplet {
...
public void setup() {
  ...
  start = new IntVect(width*0.85f, height*0.75f);
  time = 0;
  outPutNum=0;
  ...
  goals.add(new IntVect(width*0.62f, height*0.72f));
  goals.add(new IntVect(width*0.4f, height*0.7f));
  goals.add(new IntVect(width*0.7f, height*0.3f));
  goals.add(new IntVect(width*0.85f, height*0.6f));
}
...
class Dolly {
  ...
  public void act() {
    ...
    float dis = p.dist(((IntVect) goals.get(goalsReached)));
...
public int[] pushIntoArray(int a, int[] l, int s){ // a = number l = list | s = startpoint of push
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#FFFFFF", "AmitaiProject1_7" });
  }
}
